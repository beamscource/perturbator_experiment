function createStimsFRICB(subjectFolder, gender, formants, pertSet, phase)
	...
	if strcmp(phase, 'baseline')
		...
		txtStruct{1} = '1';
		txtStruct{2} = 'Произносите слова, пока рамка зелёная..';
		...
		txtStruct{12} = 'лещ';
		txtStruct{13} = ['lSj_1_0000_05_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{14} = 'вещь';
		txtStruct{15} = ['vSj_1_0000_06_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{16} = 'режь';
		txtStruct{17} = ['rS_1_0000_07_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{18} = 'меж';
		txtStruct{19} = ['mS_1_0000_08_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct = txtStruct';
	...
	elseif strcmp(phase, 'crosseffects')

		fields = fieldnames(pertSet);

		pertSettingsA = pertSet.(fields{1});
		pertSettingsB = pertSet.(fields{1+1});

		txtStruct{1} = '1';
		txtStruct{2} = 'Произносите слова, пока рамка зелёная.';
		txtStruct{3} = ['Aufgabenbeschreibung 5' phase]; 
		txtStruct{4} = 'лес';
		txtStruct{5} = ['ls_1_0000_01_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{6} = 'вес';
		txtStruct{7} = ['vs_1_0000_02_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		...
		txtStruct{9} = ['lsj_1_0000_03_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{10} = 'весь';
		txtStruct{11} = ['vsj_1_0000_04_REP#fb 1#pertAmp 0#pertPhi pi*0' pertSettingsB];
		txtStruct{12} = 'лещ';
		txtStruct{13} = ['lSj_1_0000_05_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{14} = 'вещь';
		txtStruct{15} = ['vSj_1_0000_06_REP#fb 1#pertAmp 0#pertPhi pi*0' pertSettingsA];
		txtStruct{16} = 'режь';
		txtStruct{17} = ['rS_1_0000_07_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{18} = 'меж';
		txtStruct{19} = ['mS_1_0000_08_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		...
		for i = [1]
			...
			txtStruct{1} = '1';
			txtStruct{2} = 'Произносите слова, пока рамка зелёная.';
			txtStruct{3} = ['Aufgabenbeschreibung ' phase '_test'];
			txtStruct{4} = 'весь';
			txtStruct{5} = ['vsj_1_0000_01_REP#fb 1#pertAmp 0#pertPhi pi*0' pertSettingsB]; 
			txtStruct{6} = 'вещь';
			txtStruct{7} = ['vSj_1_0000_02_REP#fb 1#pertAmp 0#pertPhi pi*0' pertSettingsA];
			txtAStruct = txtStruct';

			% number of repetition per word
			repetitionsA = 15; %less repetitions?
			clear txtStruct
			...
			txtStruct{3} = 'лес';
			txtStruct{4} = ['ls_1_0000_01_REP#fb 1#pertAmp 0#pertPhi pi*0%masked feedback'];
			txtStruct{5} = 'вес';
			txtStruct{6} = ['vs_1_0000_02_REP#fb 1#pertAmp 0#pertPhi pi*0%masked feedback'];
			txtStruct{7} = 'лезь';
			...
			txtStruct{15} = 'режь';
			txtStruct{16} = ['rS_1_0000_07_REP#fb 2#pertAmp 0#pertPhi pi*0%masked feedback'];
			txtStruct{17} = 'меж';
			txtStruct{18} = ['mS_1_0000_08_REP#fb 2#pertAmp 0#pertPhi pi*0%masked feedback'];
