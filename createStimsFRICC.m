function createStimsFRICC(subjectFolder, gender, formants, pertSet, phase)
	...
	elseif strcmp(phase, 'crosseffects')
		...
		txtStruct{7} = ['vs_1_0000_02_REP#fb 1#pertAmp 0#pertPhi pi*0%no perturbation'];
		txtStruct{8} = 'лезь';
		txtStruct{9} = ['lsj_1_0000_03_REP#fb 1#pertAmp 0#pertPhi pi*0' pertSettingsA];
		txtStruct{10} = 'весь';
		...
		for i = [1]
			...
			%% testing block
			txtStruct{1} = 'Произносите слова, пока рамка зелёная. Не обращайте внимание на шум.';
			...
			txtStruct{11} = 'лещ';
			txtStruct{12} = ['lSj_1_0000_05_REP#fb 2#pertAmp 0#pertPhi pi*0%masked feedback'];
			txtStruct{13} = 'вещь';
			txtStruct{14} = ['vSj_1_0000_06_REP#fb 2#pertAmp 0#pertPhi pi*0%masked feedback'];
