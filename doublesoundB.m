function doublesoundB(subjectID)
	...
	% here is the version B created via different perturbation settings
	...
	disp ('Enter return to the console to start the remaining phases (3*50 trials).')
	keyboard
